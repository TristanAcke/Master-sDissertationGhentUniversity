...
with open('FILEPATH TO not_annotated_normative_text_spaCy_X_training_articles.json', 'r') as file:
    not_annotated_normative_text_spaCy_X_training_articles = json.load(file)
...
with open('FILEPATH TO not_annotated_normative_text_spaCy_X_test_articles.json', 'r') as file:
    not_annotated_normative_text_spaCy_9_test_articles = json.load(file)
...
messages.append({
        "role": "user",
        "content": f".json-file van niet-geannoteerde tekst: {not_annotated_normative_text_spaCy_9_test_articles['artikelen'][8]}"
    })
